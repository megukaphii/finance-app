...
public class SqliteParameter : IParameter
{
    private MSSqliteParameter param;

    internal MSSqliteParameter Internal => param;

    public SqliteParameter(SqliteType type, string key, object value)
    {
        ...
        param = new MSSqliteParameter(key, type) { Value = value };
        param.Value = value;
    }
