...
public class TransactionTest
{
	...
	private static readonly string MessageCreteRequest =
		$"{CreateTransaction.Flag}{JsonSerializer.Serialize(TestCreateTransactionRequest)}";
	...
	private static readonly string MessageIndexRequest =
		$"{GetTransactions.Flag}{JsonSerializer.Serialize(TestIndexRequest)}";
